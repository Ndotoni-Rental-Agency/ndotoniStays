    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-brand-50/50 to-white px-6">
      <div className="max-w-sm w-full text-center space-y-8 py-16">
        ...
        <div className="space-y-3">
          ...
          {/* Android — coming soon */}
          <div className="flex items-center gap-3 w-full px-5 py-3.5 border border-ink-100 rounded-xl bg-ink-50 opacity-60 cursor-not-allowed">
            <svg className="w-8 h-8 text-ink-400 shrink-0" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="text-left">
              <div className="text-[10px] text-ink-400 uppercase tracking-wide">Coming soon on</div>
              <div className="text-base font-semibold text-ink-400">Google Play</div>
            </div>
          </div>
        </div>
