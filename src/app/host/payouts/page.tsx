  ...
  useEffect(() => {
    if (user) {
      ...
      setFormData({
        ...
        payoutMpesaPhone: u.payoutMpesaPhone || user.phoneNumber || '',
        payoutBankName: u.payoutBankName || '',
        payoutBankAccountName: u.payoutBankAccountName || '',
        payoutBankAccountNumber: u.payoutBankAccountNumber || '',
    ...
    <div className="max-w-xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-ink-100 p-6 space-y-6">
        ...
        <button
          onClick={handleSave}
          disabled={loading}
          className="w-full py-3 rounded-xl bg-brand-600 hover:bg-brand-700 disabled:opacity-50 text-white text-sm font-semibold transition-colors"
        >
