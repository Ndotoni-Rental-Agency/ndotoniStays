...
// Update this once the Android app is live on Play Store
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-6">
      <div className="max-w-md w-full text-center space-y-8">
        <div className="space-y-3">
          <h1 className="text-3xl font-bold text-ink-900">Get the ndotoni App</h1>
        ...
        <div className="space-y-4">
          ...
          <a
            href={IOS_APP_URL}
            className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-ink-900 text-white rounded-xl hover:bg-ink-800 transition"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full px-6 py-4 bg-ink-900 text-white rounded-xl hover:bg-ink-800 transition opacity-50 pointer-events-none"
            aria-disabled="true"
          >
            <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-xs text-ink-400">
          Or continue on the web at{' '}
          <a href={FALLBACK_URL} className="underline hover:text-ink-600">
            ndotonistays.com
          </a>
        </p>
      </div>
